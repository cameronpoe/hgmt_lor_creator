...
typedef struct event_ {
	...
	uint dir_cos_neg; // 9: Flag to tell if Third Direction Cosine is Negative (1 means true)
	uint first_in_hist; // 10: Flag to tell if this is the First Scored Particle from this History (1 means true)
